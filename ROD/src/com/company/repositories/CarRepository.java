...
public class CarRepository implements ICarRepository {
    ...
    public List<Car> showAllAvailableCars() {
        ...
        try {
            connection = DB.getConnection();
//            String availableCars = "SELECT * FROM cars WHERE status = '1' order by id ";
...
//            String sql = "update cars SET owner_id = ? where id = ?";
...
//            String sql = "update cars SET owner_id = clientID where id = ID";
//            PreparedStatement preparedStatement2 = connection.prepareStatement(sql);
//            preparedStatement2.executeUpdate();
...
//            preparedStatement.setBoolean(6, car.getStatus());
